...
namespace basics
{
    class Basics
    {
        ...
        public static Hashtable DocTypes = new Hashtable() {
...
{"IHCEBI","Interactive health insurance eligibility and benefits inquiry"},
...
{"PASREQ","Travel tourism and leisure product application status reques"},
{"PASRSP","Travel tourism and leisure"},
